...
algorithm track at ALX Software Engineering (ALX SE) Program. In these projects, which  occurred
throughout the duration of the 1 year curriculum, I learned about data
...
* [0x11. C - printf](https://github.com/Ngadi-Git/printf/tree/master)
...
* [0x16. C - Simple Shell](https://github.com/Ngadi-Git/simple_shell/tree/master)
* [0x17. C - Doubly linked lists](./0x16-doubly_linked_lists)
* [0x18. C - Dynamic libraries](./0x17-dynamic_libraries)
* [0x19. C - Stacks, Queues - LIFO, FIFO](https://github.com/Ngadi-Git/monty/tree/master)
* [0x1A. C - Hash tables](./0x19-hash_tables)

## Author :black_nib:

* __Paul N Lennon__ <[Ngadi-Git](https://github.com/Ngadi-Git)>

## Acknowledgements :pray:

All work contained in this project was completed as part of the curriculum for
ALX Africa SE Program. ALX SE is a online full-stack software engineering program that prepares 
...
<p align="center">
  <img
    src="http://www.alxafrica.com/alxafrica-logo.png"
    alt="ALX Africa logo">
</p>
